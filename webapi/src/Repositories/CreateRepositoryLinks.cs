...
namespace ZeraSystems.CodeNanite.WebAPI
{
    ...
    {
        "ZERA Systems Inc.",
        "Repository Links Creator",
        "Creates Code Nanites for Repository links",
        "1.0",
        "CreateRepositoryLinks",
        "ZeraSystems.CodeNanite.WebAPI",
        "10/04/2019",
        "CREATE_REPOSITORY_LINKS",
        "1",
        "",
        ""
    })]
    public partial class CreateRepositoryLinks: ExpansionBase, ICodeStencilCodeNanite
    {
